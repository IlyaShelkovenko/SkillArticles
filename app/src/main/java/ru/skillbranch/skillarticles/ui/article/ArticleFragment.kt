...
class ArticleFragment : BaseFragment<ArticleViewModel>(), IArticleView{
    ...
    private val commentsAdapter by lazy {
        CommentsAdapter{
            Log.d("ArticleFragment","click on comment ${it.id} ${it.slug}")
    ...
    override fun setupViews() {
        ...
        val avatarSize : Int = root.dpToIntPx(40)
        val cornerRadius : Int = root.dpToIntPx(8)
    ...
    inner class ArticleBinding() : Binding() {
        ...
        private var isLike: Boolean by RenderProp<Boolean>(false) { bottombar.btn_like.isChecked = it }

...
import kotlinx.android.synthetic.main.item_dialog_chose_category.view.*
...
class CategoryAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryVH =
        CategoryVH(LayoutInflater.from(parent.context).inflate(R.layout.item_dialog_chose_category, parent, false), listener)

...
class RootActivity : BaseActivity<ArticleViewModel>(), IArticleView {
    ...
    inner class ArticleBinding() : Binding() {
        ...
        private var isBookmark: Boolean by RenderProp<Boolean>(false) {
        ...
        private var title: String by RenderProp(getString(R.string.str_loading_res)) {
            toolbar.title = it
        }
        private var category: String by RenderProp(getString(R.string.str_loading_res)) {
            toolbar.subtitle = it
        }

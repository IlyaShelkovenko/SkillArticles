...
class RootActivity : BaseActivity<ArticleViewModel>(), IArticleView {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        ...
        searchView?.queryHint = getString(R.string.str_search_tint)
    ...
    inner class ArticleBinding() : Binding() {
        ...
        private var isLike : Boolean by RenderProp<Boolean>(false) {btn_like.isChecked = it}
        private var isBookmark : Boolean by RenderProp<Boolean>(false) {btn_bookmark.isChecked = it}
        private var isShowMenu : Boolean by RenderProp<Boolean>(false) {
            btn_settings.isChecked = it
            if(it) submenu.open() else submenu.close()
        }
        private var title: String by RenderProp(getString(R.string.str_loading_res)) { toolbar.title = it }
        private var category: String by RenderProp(getString(R.string.str_loading_res)) { toolbar.subtitle = it }
        ...
        private var content: String by ObserveProp(getString(R.string.str_loading_res)) {
